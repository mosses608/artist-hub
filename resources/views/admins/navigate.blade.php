...
<div class="page_navigation_links">
 ...
 @endauth
 <button class="currentDate" style="color:red; margin-left:6%;">currentDate</button>
 <script>
...
<div class="news_board">
    <a href="#">Post News</a><br>
    <a href="#">Time Table</a><br>
    <a href="#">View Comments</a><br>
    <a href="/listings/updates" class="recently-updates">News (music&movies)</a>
</div>
