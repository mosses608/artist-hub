...
<x-card>
            ...
            <h2><a href="/listings/show/{{$listing->id}}" class="name">Name: {{$listing->artist_name}}</a></h2>
            ...
            <p style="font-size:12px; background-color:#864AF9; width:95%; color:#FFFFFF; border-radius:10px; text-align:center;" class="created-in" id="created-in">{{$listing->artist_name}} posted this profile in {{$listing->created_at}}</p><br>
</x-card>